...
import { addProduct, editOrder, getOrder, getProduct, productDelete, productEdit } from "../controller/admin.controller.js"
...
admin.patch('/admin/editorder/:id', userProtection, editOrder) //untuk mengedit status order
